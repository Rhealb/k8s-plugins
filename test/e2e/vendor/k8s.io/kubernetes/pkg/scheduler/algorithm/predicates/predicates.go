...
const (
	...
	KeyNodeNameSpacePredicate       = "NodeNameSpacePredicate"
	KeyPodHostPathPVDiskPressure    = "PodHostPathPVDiskPressure"
	KeyHostPathPVAffinityPredicate  = "HostPathPVAffinityPredicate"
	KeyHostPathPVAffinityPredicate2 = "HostPathPVAffinityPredicate2"
	KeyNamespacesNodeSelector       = "NamespacesNodeSelector"
...
var (
	predicatesOrdering = []string{CheckNodeConditionPred, CheckNodeUnschedulablePred,
		...
		KeyNodeNameSpacePredicate, KeyPodHostPathPVDiskPressure, KeyHostPathPVAffinityPredicate, KeyHostPathPVAffinityPredicate2, KeyNamespacesNodeSelector}
)
...
func PodNamespaceSelect(pod *v1.Pod, meta algorithm.PredicateMetadata, nodeInfo *schedulercache.NodeInfo) (bool, []algorithm.PredicateFailureReason, error) {
	for _, nodePod := range nodeInfo.Pods() {
		if pod.Namespace != nodePod.Namespace {
			return false, []algorithm.PredicateFailureReason{ErrNameSpaceNotMatch}, nil
		}
	}
	return true, nil, nil
}
