...
type SchdulerConfig interface {
	GetPredicates() map[string]FitPredicate
	AddPredicate(predicatName string) (bool, error)
	RemovePredicate(predicatName string) (bool, error)
	GetPrioritys() []PriorityConfig
	AddPriority(priorityName string) (bool, error)
	RemovePriority(priorityName string) (bool, error)
}
