...
var (
	...
	ErrNameSpaceNotMatch = newPredicateFailureError("NameSpaceNotMatch", "NameSpaceNotMatch")

	ErrPodHostPathPVDiskPressure    = newPredicateFailureError("PodHostPathPVDiskPressure", "PodHostPathPVDiskPressure")
	ErrHostPathPVAffinityPredicate  = newPredicateFailureError("HostPathPVAffinityPredicate", "HostPathPVAffinityPredicate")
	ErrHostPathPVAffinityPredicate2 = newPredicateFailureError("HostPathPVAffinityPredicate2", "HostPathPVAffinityPredicate2")
)
