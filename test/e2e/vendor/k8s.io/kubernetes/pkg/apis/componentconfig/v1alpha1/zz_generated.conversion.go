...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_FailPodScalerConfiguration_To_componentconfig_FailPodScalerConfiguration,
		Convert_componentconfig_FailPodScalerConfiguration_To_v1alpha1_FailPodScalerConfiguration,
...
func autoConvert_v1alpha1_FailPodScalerConfiguration_To_componentconfig_FailPodScalerConfiguration(in *FailPodScalerConfiguration, out *componentconfig.FailPodScalerConfiguration, s conversion.Scope) error {
	out.FailPodScaleLimit = in.FailPodScaleLimit
	return nil
}

// Convert_v1alpha1_FailPodScalerConfiguration_To_componentconfig_FailPodScalerConfiguration is an autogenerated conversion function.
func Convert_v1alpha1_FailPodScalerConfiguration_To_componentconfig_FailPodScalerConfiguration(in *FailPodScalerConfiguration, out *componentconfig.FailPodScalerConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_FailPodScalerConfiguration_To_componentconfig_FailPodScalerConfiguration(in, out, s)
}

func autoConvert_componentconfig_FailPodScalerConfiguration_To_v1alpha1_FailPodScalerConfiguration(in *componentconfig.FailPodScalerConfiguration, out *FailPodScalerConfiguration, s conversion.Scope) error {
	out.FailPodScaleLimit = in.FailPodScaleLimit
	return nil
}

// Convert_componentconfig_FailPodScalerConfiguration_To_v1alpha1_FailPodScalerConfiguration is an autogenerated conversion function.
func Convert_componentconfig_FailPodScalerConfiguration_To_v1alpha1_FailPodScalerConfiguration(in *componentconfig.FailPodScalerConfiguration, out *FailPodScalerConfiguration, s conversion.Scope) error {
	return autoConvert_componentconfig_FailPodScalerConfiguration_To_v1alpha1_FailPodScalerConfiguration(in, out, s)
}
...
func autoConvert_v1alpha1_KubeControllerManagerConfiguration_To_componentconfig_KubeControllerManagerConfiguration(in *KubeControllerManagerConfiguration, out *componentconfig.KubeControllerManagerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_FailPodScalerConfiguration_To_componentconfig_FailPodScalerConfiguration(&in.FPSController, &out.FPSController, s); err != nil {
		return err
	}
...
func autoConvert_componentconfig_KubeControllerManagerConfiguration_To_v1alpha1_KubeControllerManagerConfiguration(in *componentconfig.KubeControllerManagerConfiguration, out *KubeControllerManagerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_componentconfig_FailPodScalerConfiguration_To_v1alpha1_FailPodScalerConfiguration(&in.FPSController, &out.FPSController, s); err != nil {
		return err
	}
	out.Controllers = *(*[]string)(unsafe.Pointer(&in.Controllers))
	out.ExternalCloudVolumePlugin = in.ExternalCloudVolumePlugin
...
func autoConvert_v1alpha1_KubeSchedulerConfiguration_To_componentconfig_KubeSchedulerConfiguration(in *KubeSchedulerConfiguration, out *componentconfig.KubeSchedulerConfiguration, s conversion.Scope) error {
	...
	out.BaseAuthCVSFile = in.BaseAuthCVSFile
