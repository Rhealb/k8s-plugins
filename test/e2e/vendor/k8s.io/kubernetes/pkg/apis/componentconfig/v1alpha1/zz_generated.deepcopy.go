...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailPodScalerConfiguration) DeepCopyInto(out *FailPodScalerConfiguration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailPodScalerConfiguration.
func (in *FailPodScalerConfiguration) DeepCopy() *FailPodScalerConfiguration {
	if in == nil {
		return nil
	}
	out := new(FailPodScalerConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubeControllerManagerConfiguration) DeepCopyInto(out *KubeControllerManagerConfiguration) {
	*out = *in
	...
	out.ServiceController = in.ServiceController
	out.FPSController = in.FPSController
