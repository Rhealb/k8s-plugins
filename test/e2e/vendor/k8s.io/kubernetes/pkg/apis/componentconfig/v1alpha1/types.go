...
type KubeSchedulerConfiguration struct {
	...
	// KubeSchedulerPolicyConfig enables predicate and priority policy config by web interface.
	ServerCertPath  string `json:"serverCertPath"`
	ServerKeyPath   string `json:"serverKeyPath"`
	BaseAuthCVSFile string `json:"baseAuthCVSFile"`
...
type KubeControllerManagerConfiguration struct {
	...
	// FailPodScalerConfiguration holds configuration for FailPodScalerController
	FPSController FailPodScalerConfiguration
...
type FailPodScalerConfiguration struct {
	// pods crash count above the limit the pods will be recycle
